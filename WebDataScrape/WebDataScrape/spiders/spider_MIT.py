...
class SpiderMitSpider(scrapy.Spider):
    ...
    # Further URLs can be included to this list when the spider is used to crawl again. The pipelines.py file will ensure that only the new data will be scrapy and added to the existing tables.

    def parse(self, response):
        # Extract the title, description url etc from the webpage
